...
from callcenter import router as callcenter_router
...
async def classify(req: ClassifyIn):
    async with pipeline_module.cls_sem:
        return await asyncio.to_thread(pipeline_module.classifier, req.text)
